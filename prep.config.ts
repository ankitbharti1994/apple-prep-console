...
export const prep = {
  ...
  rhythm: [
    ...
    // Revised 8 Sep: phase 2 Saturdays run to 11:30 to carry the DP block.
    { slot: 'Sat 9:00–11:00', block: 'Build block → DP + showcase from week 4 (to 11:30) → system design + STAR from week 7', runs: 'Every week' },
